		...
		return (
			<MDBContainer>
				<p>
					...
					{Math.round((this.props.participantsQty / this.props.limit) * 100)}%
					have participated in the event{" "}
				</p>
				<p>
					{this.state.feedbacksQty}/{this.props.limit}, ie.{" "}
					{Math.round((this.state.feedbacksQty / this.props.limit) * 100)}% of
					participants have submitted feedbacks
				</p>
